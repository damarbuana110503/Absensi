<div>
    <div wire:ignore.self class="modal fade" id="modal-dosen">
                ...
                <div class="row">
                    <div class="col-12 table-responsive">
                        <table class="table table-bordered mb-0">
                            <thead>
                                <tr>
                                    <th class="align-middle px-2 py-2 text-center" width="15%">Kode NIDN</th>
                                    <th class="align-middle px-2 py-2 text-center">Nama Dosen</th>
                            ...
                            <tbody>
                                ...
                                @empty
                                <tr>
                                    <td colspan="3" class="align-middle px-2 py-2 text-center">Belum Ada Dosen</td>
                                </tr>
                                @endforelse
                            </tbody>
                        </table>
...
@push('script')
    <script>
        $(document).ready(function () {
            Livewire.on('modal-dosen', function(showValue) {
                $('#modal-dosen').modal(showValue);
            });
        });
    </script>
@endpush
