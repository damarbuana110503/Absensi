                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="FK_JURUSAN">Kode Jurusan : </label>
                                <input type="text" wire:model="state.FK_JURUSAN" name="kode_jurusan" id="kode_jurusan" class="form-control form-control-sm {{ $errors->has('state.FK_JURUSAN') ? 'is-invalid' : '' }}" placeholder="Masukan Kode Jurusan..." {{ $state['edit'] == true ? 'disabled' : '' }} maxlength="5" required>
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                <label for="FN_JURUSAN">Nama Jurusan : </label>
                                <input type="text" wire:model="state.FN_JURUSAN" name="nama_jurusan" id="nama_jurusan" class="form-control form-control-sm {{ $errors->has('state.FN_JURUSAN') }}" placeholder="Masukan Nama Jurusan..." required>
                                <div class="invalid-feedback">
                                    {{ $errors->first('state.FN_JURUSAN') }}
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th class="align-middle px-2 py-2 text-center">Kode Jurusan</th>
                        ...
                        <tbody>
                            @forelse ($dataJurusan as $item )
                                <tr>
                                    ...
                                    <td class="align-middle px-2 py-2 text-center">{{ $item->FK_JURUSAN }}</td>
                                    <td class="align-middle px-2 py-2 text-center">{{ $item->FN_JURUSAN }}</td>
                                    <td class="align-middle px-2 py-2 text-center">
                                        <div class="btn-group">
                                            <button class="btn btn-xs btn-warning px-3" wire:click="editData('{{ $item->FK_JURUSAN }}')">
                                                <span class="fa fa-edit"></span>
                                            </button>
                                            <button class="btn btn-xs btn-danger px-3" wire:click="deleteData('{{ $item->FK_JURUSAN }}')">
